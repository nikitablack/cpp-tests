...
Graphics::Graphics(UINT const bufferCount, shared_ptr<Window> const window) : _bufferCount{ bufferCount }
{
	createFactory();
...
void Graphics::createSwapChain(shared_ptr<Window> const window)
{
